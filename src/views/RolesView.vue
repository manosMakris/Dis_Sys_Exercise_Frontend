                ...
                <ul>
                    <li style="color: blue;">
                        <RouterLink
                            class="nav-link"
                            :to="{ name: 'role-new'}"
                            >Create new Role</RouterLink
                        >
                    </li>
                </ul>
                <div class="col-12">
                    <div class="mb-4">
                        <h1 class="fs-3">Roles</h1>
                    </div>
                    <div>
                        <table class="table">
                            <thead>
                                ...
                                <tr v-for="role in data" :key="role.id">
                                    ...
                                    <td>
                                        ...
                                        <RouterLink style="margin-left: 5%;" class="btn btn-primary update-button"
                                            ...
                                            Update</RouterLink
                                        >
                                        <button @click="removeRole(role.id)" style="margin-left: 5%;" class="btn btn-danger">
